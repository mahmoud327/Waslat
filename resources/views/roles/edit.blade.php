...
@section('head-content')
    @include('partials.title-meta', ['title' => __('roles.title')])
                                                    ...
                                                    <ul id="treeview1">
                                                        ...
                                                        @foreach($permission as $value)
                                                            ...
                                                            <label style="font-size: 16px;">
                                                                <td><input id="cat-box" type="checkbox" name="permission[]" value="{{ $value->id }}" class="box1" @if (in_array($value->id, $rolePermissions)) checked @endif></td>
                                                                {{ $value->name }}
                                                            </label>
                                                        @endforeach
                                                    </ul>
