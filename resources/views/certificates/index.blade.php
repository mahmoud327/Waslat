            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">@lang('lang.Certificates')</h4>
                                    ...
                                    <table id="datatable" class="table table-bordered"
                                        ...
                                        <tbody>
                                            @foreach ($banners as $banner)
                                                ...
                                                @include('certificates.edit_modal', ['banner' => $banner])
                                                @include('certificates.delete_modal', ['banner' => $banner])
                                            @endforeach

                                            @include('certificates.add_modal')
