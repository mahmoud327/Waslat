                            ...
                            <div class="card-body">
                                <div class="d-flex text-muted">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <h5 class="mb-3">{{ App\Models\User::count() }}</h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="mb-1">{{ __('lang.Auctions') }}</p>
                                        <h5 class="mb-3">{{ App\Models\Auction::count() }}</h5>
                                    ...
                                    <table class="table table-centered table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="avatar-xs">
                                                        <span class="avatar-title rounded-circle bg-primary-subtle text-success">
                                                            W
                                                        </span>
                                                    </div>
                                                </td>
