                ...
                <div class="row">
                    <div class="col-12">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#bannerAddModal">
                            @lang('lang.Add About us')
                        </button>
                        <br>
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">@lang('lang.About us')</h4>
                                        ...
                                        <tbody>
                                            @foreach ($banners as $banner)
                                                <tr>
                                                    ...
                                                    <td>{{ $banner->getTranslation('description', app()->getLocale()) }}</td>
                                                    <td>
                                                ...
                                                @include('about-us.edit_modal', ['banner' => $banner])
                                                @include('about-us.delete_modal', ['banner' => $banner])
                                            @endforeach

                                            @include('about-us.add_modal')
