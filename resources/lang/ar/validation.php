...
return [
    ...
    */
    'attributes' => [
        ...
        'message' => 'حقل الرساله',
        'user_type' => 'حقل الطرف',
        'job_title' => 'حقل اللقب الوظيفي',
        'nationality' => ' حقل الجنسبة ',
        'id_number' => 'حقل رقم الهويه',
        'scientific_degree' => 'حقل الدرجة العلمية',
        'Specialization' => 'حقل مجال تخصص الشركة',
        'years_experience' => 'حقل سنوات الخبره',
        'department_id' => 'حقل قسم',
        'cv' => 'حقل السيرة الذاتية',
        'bio' => 'حقل نبذه عنك',
        'commission_rate' => 'حقل نسبة العمولة',
        'name_en' => 'حقل الإسم الإنجليزي',
        'name_ar' => 'حقل الإسم العربي',
        'price' => 'حقل السعر',
        'from_date' => 'حقل تاريخ البدايه',
        'to_date' => 'حقل تاريخ الانتهاء',
        'info' => 'حقل معلومات اضافيه',
        'agreement' => 'حقل الموافقه على  ',
